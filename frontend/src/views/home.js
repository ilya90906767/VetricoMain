    ...
    <div className="home-container">
      ...
      <div className="home-header">
        ...
        >
          ...
          <span className="home-logo">Vetrico</span>
          <div
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links">
                ...
                <span className="home-nav22 bodySmall">Mosaics</span>
                <span className="home-nav32 bodySmall">Gallery</span>
      ...
      <div className="home-banner">
        <h1 className="home-text1">Каталог стандартных мозаик</h1>
        <div className="home-btn-group">
          <button className="home-button button">Предыдущая страница</button>
          <button className="home-button1 button">Следующая страница</button>
        </div>
      </div>
      <div className="home-gallery">
        <GalleryCard11
          title="Добрыня"
          imageSrc="https://i.pinimg.com/736x/30/5f/ba/305fba4c2fab25a33638103fa5675b19.jpg"
      ...
      <div className="home-banner1">
        <div className="home-btn-group1">
          <button className="home-button2 button">Предыдущая страница</button>
          <button className="home-button3 button">Следующая страница</button>
        </div>
      </div>
